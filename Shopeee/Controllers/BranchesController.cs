...
namespace Shopeee.Controllers
{
    public class BranchesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Location,Address,OpenHours")] Branch branch)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Location,Address,OpenHours")] Branch branch)
        {
            if (id != branch.Id)
            {
                return NotFound();
